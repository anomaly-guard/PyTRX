...
class Contract(object):
    ...
    def update_user_resource_percent(self, percent: int) -> "pytrx.tron.TransactionBuilder":
    ...
    def update_origin_energy_limit(self, limit: int) -> "pytrx.tron.TransactionBuilder":
    ...
    def clear_abi(self) -> "pytrx.tron.TransactionBuilder":
        """Clear contract ABI."""
        if self.origin_address != self.owner_address:
            raise RuntimeError("origin address and owner address mismatch")
...
class ContractMethod(object):
    ...
    def with_owner(self, addr: str) -> "ContractMethod":
        ...
        Can also be changed through :meth:`TransactionBuilder.with_owner() <pytrx.tron.TransactionBuilder.with_owner>`.
        """
    ...
    def call(self, *args, **kwargs) -> "pytrx.tron.TransactionBuilder":
    ...
    def __call__(self, *args, **kwargs) -> "pytrx.tron.TransactionBuilder":
        """Call the contract method."""
        parameter = ""
...
class ShieldedTRC20(object):
    ...
    def mint(self, taddr: str, zaddr: str, amount: int, memo: str = "") -> "pytrx.tron.TransactionBuilder":
