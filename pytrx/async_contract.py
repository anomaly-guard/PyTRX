...
from pytrx.exceptions import DoubleSpending
from pytrx.abi import trx_abi
...
class AsyncContract(object):
    ...
    def update_user_resource_percent(self, percent: int) -> "pytrx.async_tron.AsyncTransactionBuilder":
    ...
    def update_origin_energy_limit(self, limit: int) -> "pytrx.async_tron.AsyncTransactionBuilder":
    ...
    def clear_abi(self) -> "pytrx.async_tron.AsyncTransactionBuilder":
        """Clear contract ABI."""
        if self.origin_address != self.owner_address:
            raise RuntimeError("origin address and owner address mismatch")
...
class AsyncContractMethod(object):
    ...
    def with_owner(self, addr: str) -> "AsyncContractMethod":
        ...
        :meth:`TransactionBuilder.with_owner() <pytrx.async_tron.AsyncTransactionBuilder.with_owner>`.
        """
    ...
    async def call(self, *args, **kwargs) -> "pytrx.async_tron.AsyncTransactionBuilder":
    ...
    async def __call__(self, *args, **kwargs) -> "pytrx.async_tron.AsyncTransactionBuilder":
        """Call the contract method."""
        parameter = ""
...
class ShieldedTRC20(object):
    ...
    ) -> "pytrx.async_tron.AsyncTransactionBuilder":
